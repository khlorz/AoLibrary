...
Copy and paste the contents of `absl` to `absl/`
...
Copy and paste the contents of `boost` to `boost/`
...
Copy and paste the contents of `include/tsl` to `tsl/`
...
Copy and paste the contents of `include/type_safe` to `type_safe/`

Copy and paste `debug_assert.hpp` to `type_safe/detail`
...
Copy and paste the contents of `include/ankerl` to `unordered_dense/`
